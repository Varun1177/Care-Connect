...
class _DonateScreenState extends State<DonateScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text("Donate to a Cause"), backgroundColor: Colors.orange),
      body: Padding(
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return _buildCauseCard(donationCauses[index]);
                },
              ),
            ),
  ...
  // Widget for Amount Selection Buttons
  ...
  // Widget for Cause Selection Cards
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
              "Thank you for donating ₹$_selectedAmount to $_selectedCause!"),
          actions: [
            TextButton(
