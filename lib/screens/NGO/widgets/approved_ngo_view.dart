...
import '../campaign_drives_screens.dart';
import '../celebrity_feature_screen.dart';

class ApprovedNGOView extends StatelessWidget {
  final DocumentSnapshot ngoData;
  const ApprovedNGOView({Key? key, required this.ngoData}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    if (!ngoData.exists || ngoData.data() == null) {
      return Scaffold(
        appBar: AppBar(title: const Text("NGO View")),
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      CircleAvatar(
                        ...
                        child: logoUrl.isEmpty
                            ? Icon(Icons.business_rounded, size: 35, color: Colors.grey[400])
                            : null,
                      ),
                      const SizedBox(width: 16),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(sector, style: const TextStyle(fontSize: 14, color: Colors.white)),
                            ),
                          ],
                        ),
                      ),
                  ...
                  Container(
                    ...
                    child: Text(description, style: const TextStyle(color: Colors.white, fontSize: 14, height: 1.4)),
                  ),
                ],
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    childAspectRatio: 1.3,
                    children: [
                      DashboardCard(title: "Donations", value: "₹24,500", icon: Icons.monetization_on_outlined, color: Colors.blue, onTap: () {}),
                      DashboardCard(title: "Campaigns", value: "4", icon: Icons.campaign_outlined, color: Colors.purple, onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (_) => const CampaignDrivesScreen()));
                      }),
                      DashboardCard(title: "Supporters", value: "184", icon: Icons.people_outline, color: Colors.lightGreen, onTap: () {}),
                      DashboardCard(title: "Requests", value: "12", icon: Icons.inbox_outlined, color: Colors.orange, onTap: () {}),
                    ],
                  ),
                ],
              ),
                  ...
                  Wrap(
                    ...
                    children: acceptedDonations.map<Widget>((type) {
                      ...
                      switch (type) {
                        ...
                        case 'Clothes': icon = Icons.checkroom_outlined; color = Colors.blue; break;
                        case 'Books': icon = Icons.book_outlined; color = Colors.orange; break;
                        case 'Food': icon = Icons.fastfood_outlined; color = Colors.red; break;
                        default: icon = Icons.volunteer_activism; color = Colors.purple;
                      }
                      return Container(
                        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                        decoration: BoxDecoration(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: ActionCard(title: "Create Campaign", icon: Icons.campaign_outlined, color: Colors.blue, onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (_) => const CreateCampaignScreen()));
                      })),
                      const SizedBox(width: 16),
                      Expanded(child: ActionCard(title: "Donation History", icon: Icons.history, color: Colors.purple, onTap: () {
                  ...
                  Row(
                    children: [
                      Expanded(child: ActionCard(title: "Edit Profile", icon: Icons.edit_outlined, color: Colors.lightGreen, onTap: () {})),
                      const SizedBox(width: 16),
                      Expanded(child: ActionCard(title: "Contact Support", icon: Icons.support_agent_outlined, color: Colors.orange, onTap: () {})),
                    ],
                  ),
                  const SizedBox(height: 16),
                  Row(
                    children: [
                      Expanded(child: ActionCard(title: "Celebrity Feature", icon: Icons.star, color: Colors.redAccent, onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (_) => const CelebrityFeatureScreen()));
                      })),
                    ],
                  ),
                ],
      ...
      child: Ink(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(title, textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.w600, color: Colors.grey[800])),
          ],
        ),
      ),
    );
